...
/** 
 * DAO for table "ASSAY_DETAIL_BEAN".
*/
public class AssayDetailBeanDao extends AbstractDao<AssayDetailBean, Long> {

    public static final String TABLENAME = "ASSAY_DETAIL_BEAN";

    /**
     * Properties of entity AssayDetailBean.<br/>
    ...
    public AssayDetailBeanDao(DaoConfig config) {
        super(config);
    }
    
    public AssayDetailBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ASSAY_DETAIL_BEAN\" (" + //
                ...
                "\"SQXH\" TEXT);"); // 18: sqxh
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "patient_no ON ASSAY_DETAIL_BEAN" +
                " (\"PATIENT_NO\" ASC);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ASSAY_DETAIL_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, AssayDetailBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, AssayDetailBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public AssayDetailBean readEntity(Cursor cursor, int offset) {
        AssayDetailBean entity = new AssayDetailBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, AssayDetailBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(AssayDetailBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(AssayDetailBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(AssayDetailBean entity) {
