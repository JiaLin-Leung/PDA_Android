 ...
 * 功能：
 */
public class YzybhdDetailAdapter extends BaseAdapter implements StickyListHeadersAdapter {
    ...
    private YzybhdBodyAdapter yzybhdBodyAdapter;
    public YzybhdDetailAdapter(Context context, List<WjbqsBean.WjbqsBeanListBean> bodyList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        YzybhdDetailAdapter.BodyHolder bodyHolder = null;
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.yzybhd_list_body, viewGroup, false);
            bodyHolder = new YzybhdDetailAdapter.BodyHolder(view);
            view.setTag(bodyHolder);
        } else {
            bodyHolder = (YzybhdDetailAdapter.BodyHolder) view.getTag();
        }
        ...
        //设置数据
        yzybhdBodyAdapter=new YzybhdBodyAdapter(context,bodyList.get(i).getList(),bodyList);
        bodyHolder.bodyrv.setAdapter(yzybhdBodyAdapter);
        return view;
    }
    ...
    public View getHeaderView(final int position, View convertView, ViewGroup parent) {
        YzybhdDetailAdapter.HeadHolder headHolder = null;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.yzybhd_head, parent, false);
            headHolder = new YzybhdDetailAdapter.HeadHolder(convertView);
            convertView.setTag(headHolder);
        } else {
            headHolder = (YzybhdDetailAdapter.HeadHolder) convertView.getTag();
        }
            //设置数据
        ...
        public void setItemSize(){
             ...
             yzybhdBodyAdapter.setthandle(handler);
        }
