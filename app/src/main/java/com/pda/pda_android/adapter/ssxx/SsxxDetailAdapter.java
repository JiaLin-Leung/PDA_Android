 ...
 */
public class SsxxDetailAdapter extends BaseAdapter implements StickyListHeadersAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.ssxx_list_body, viewGroup, false);
        ...
        //设置数据
        bodyHolder.bodyrv.setAdapter(new SsxxBodyAdapter(context,bodyList.get(i).getList(),name));
